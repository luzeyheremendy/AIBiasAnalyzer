...
function createCompassChart(data, width, height) {
    ...
    const layout = {
        ...
        legend: {
            ...
            entrywidth: 400 // Explicitly set entry width
        },
        shapes: [
            // Ejes
        ...
        annotations: [
            ...
            {
                x: -0.15, y: 0.5, xref: 'paper', yref: 'paper', // Further adjusted x position relative to paper
                text: 'izquierda',
            ...
            {
                x: 1.15, y: 0.5, xref: 'paper', yref: 'paper', // Further adjusted x position relative to paper
                text: 'derecha',
                showarrow: false, font: { size: 18, color: '#111827' }, align: 'center',
            ...
            {
                x: 0.5, y: -0.12, xref: 'paper', yref: 'paper', // Adjusted y position relative to paper for symmetry
                text: 'libertario',
                showarrow: false, font: { size: 18, color: '#111827' }, align: 'center',
